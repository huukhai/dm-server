 ...
 *
 * @version $Id: Wbxml.java,v 1.1.1.1 2006-11-15 11:24:55 nichele Exp $
 */
public class Wbxml {
    static public final int WBXML_VERSION_11          = 0x01; // version 1.1
    static public final int WBXML_VERSION_12          = 0x02; // version 1.2
    static public final int WBXML_PUBLICID            = 0x01; // unknown or missing public identifier
    static public final int WBXML_CHARSET_NOTSPECIFIED= 0x00;
    static public final int WBXML_CHARSET_ISO_8859_1  = 0x04;
    static public final int WBXML_CHARSET_UTF8        = 0x6a;
