...
/**
 * Represents the header of the Notification message in according with the SyncML DM specification.
 *
 *
 *
 * @version $Id: TriggerHeaderNotificationMessage.java,v 1.3 2006/11/15 14:00:24 nichele Exp $
 */
public class TriggerHeaderNotificationMessage {
     ...
     */
    public TriggerHeaderNotificationMessage(final float version,
                                            final int uiMode,
                                            final int initiator,
                                            final int sessionId,
     ...
     * @param paddingLeft indicates if padding on the left (true) or on the right (false)
