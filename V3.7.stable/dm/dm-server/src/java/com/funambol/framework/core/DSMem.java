 ...
 *
 *
 * @version $Id: DSMem.java,v 1.3 2006/11/15 14:21:53 nichele Exp $
 */
public final class DSMem
implements java.io.Serializable {
    ...
    public DSMem(final boolean sharedMem, final long maxMem, final long maxID) {
        setMaxMem(maxMem);
        setMaxID(maxID);
        this.sharedMem = (sharedMem) ? Boolean.valueOf(sharedMem) : null;
