...
/**
 * Abstract implementation of a <code>NotificationEngine</code>
 *
 * @version $Id: AbstractNotificationEngine.java,v 1.2 2006/08/07 21:09:21 nichele Exp $
 */
public abstract class AbstractNotificationEngine extends Sync4jEngine implements NotificationEngine {


    public AbstractNotificationEngine(Configuration config) {
        super(config);
    }
}
