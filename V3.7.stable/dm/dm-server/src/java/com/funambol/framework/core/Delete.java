 ...
 *
 *
 * @version $Id: Delete.java,v 1.3 2006/11/15 14:21:53 nichele Exp $
 */
...
implements java.io.Serializable {
    ...
    public Delete(final CmdID cmdID,
        ...
        this.archive = (archive) ? Boolean.valueOf(archive) : null;
        this.sftDel  = (sftDel)  ? Boolean.valueOf(sftDel)  : null;
    }
