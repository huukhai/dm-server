...
/**
 * Corresponds to the &lt;NAP&gt; interior node in the management tree
 *
 * @version $Id: NAP.java,v 1.1 2006/11/15 13:43:15 nichele Exp $
 */
public class NAP {

    // --------------------------------------------------------------- Constants

    public static final String NAP_BEARER    = "/Bearer";
    public static final String NAP_ADDR_TYPE = "/AddrType";
    public static final String NAP_ADDR      = "/Addr";
    public static final String NAP_AUTH      = "/Auth";
    ...
    // contains all the pair id/secret for each authentication methods
    ...
    /**
     * Creates a new ConNAP object with the given parameters
     *
     * @param bearer the bearer type of the connection information
     * @param address the server address
     * @param addressType the type of the server address
     *
     */
    public NAP(final String bearer,
