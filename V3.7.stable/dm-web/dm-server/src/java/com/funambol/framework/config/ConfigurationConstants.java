 ...
 *
 * @version $Id: ConfigurationConstants.java,v 1.2 2006/08/07 21:05:28 nichele Exp $
 */
public interface ConfigurationConstants {
    ...
    public static final String CFG_SESSION_HANDLER       = "engine.handler"        ;
    ...
    public static final String CFG_ENGINE_PIPELINE       = "engine.pipeline"       ;
    ...
    public static final String CFG_SERVER_DM_SELECTOR    = "server.dm.selector"    ;
    public static final String CFG_USER_MANAGER          = "user.manager"          ;

    public static final String CFG_SERVER_ID             = "server.id"             ;

    public static final String CFG_MIN_MSGSIZE_XML       = "minXMLMaxMsgSize"      ;
    public static final String CFG_MIN_MSGSIZE_WBXML     = "minWBXMLMaxMsgSize"    ;
