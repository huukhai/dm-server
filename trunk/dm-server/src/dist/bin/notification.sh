...
$JAVA_HOME/bin/java -classpath ./lib/.:$J2EE_HOME/bin/client/jboss-client.jar:./default/lib/funambol-server.jar:./default/lib/funambol-framework.jar:./default/lib/dmdemo.jar com.funambol.notification.client.Notification $*
