...
echo ERROR: you must run this script from the Funambo DM Server home directory
goto END
:CONT4
...
%JAVA_HOME%\bin\java.exe -classpath .\lib;%J2EE_HOME%\bin\client\jboss-client.jar;.\default\lib\funambol-server.jar;.\default\lib\funambol-framework.jar;.\default\lib\dmdemo.jar com.funambol.notification.client.Notification %*
:END
endlocal
