 ...
 *  @see    Credential
 *
 *  @version $Id: Chal.java,v 1.3 2006/11/15 14:22:44 nichele Exp $
 */
...
implements java.io.Serializable {
    ...
    public Chal (final Meta meta) {
        ...
        if (format == null) {
            ...
            } else if (type.equalsIgnoreCase(Constants.AUTH_TYPE_MD5)) {
                meta.setFormat(Constants.FORMAT_B64);
            } else if (type.equalsIgnoreCase(Constants.AUTH_TYPE_CLEAR)) {
                meta.setFormat(Constants.FORMAT_CLEAR);
            } else if (type.equalsIgnoreCase(Constants.AUTH_TYPE_HMAC)) {
                meta.setFormat(Constants.FORMAT_B64);
            } else {
                throw new IllegalArgumentException(
    ...
    public static Chal getBasicChal() {
        Meta m = new Meta();
        m.setType(Constants.AUTH_TYPE_BASIC);
    ...
    /**
     * Creates a clear authentication challange.
     * This will have type = Constants.AUTH_TYPE_CLEAR and
     * format = Constants.FORMAT_CLEAR
     *
     * @return the newly created AuthenticationChallange
     */
    public static Chal getClearChal() {
        Meta m = new Meta();
        m.setType(Constants.AUTH_TYPE_CLEAR);
        m.setFormat(Constants.FORMAT_CLEAR);
        m.setNextNonce(null);
        return new Chal(m);
    }
     ...
     * This will have type = Constants.AUTH_TYPE_MD5 and
     * format = Constants.FORMAT_B64
     *
     * @return the newly created AuthenticationChallange
     */
    public static Chal getMD5Chal() {
        Meta m = new Meta();
        m.setType(Constants.AUTH_TYPE_MD5);
        m.setFormat(Constants.FORMAT_B64);
        m.setNextNonce(null);
        return new Chal(m);
    }
    ...
    /**
     * Creates a HMAC authentication challange.
     * This will have type = Constants.AUTH_TYPE_HMAC and
     * format = Constants.FORMAT_B64
     *
     * @return the newly created AuthenticationChallange
     */
    public static Chal getHMACChal() {
        Meta m = new Meta();
        m.setType(Constants.AUTH_TYPE_HMAC);
        m.setFormat(Constants.FORMAT_B64);
        m.setNextNonce(null);
        return new Chal(m);
    }
