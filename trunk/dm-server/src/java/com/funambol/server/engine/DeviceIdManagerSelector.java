...
/**
 *
 * @version $Id: DeviceIdManagerSelector.java,v 1.2 2006/08/07 21:09:24 nichele Exp $
 */
public class DeviceIdManagerSelector
implements java.io.Serializable {

    private PatternPair[] patterns;
    private String defaultManager;

    /** Creates a new instance of DeviceIdManagerSelector */
    public DeviceIdManagerSelector() {
    }
