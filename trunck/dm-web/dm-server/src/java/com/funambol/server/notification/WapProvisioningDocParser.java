...
/**
 * A parser for WapProvisioningDoc built on top of the WbxmlParser by
 * setting the corresponding TagTable defined in the class WapProvisioningDocWBXML
 *
 *
 * @version $Id $
 */
public class WapProvisioningDocParser extends WbxmlParser {
     ...
     */
    public WapProvisioningDocParser (InputStream in) throws Exception {
        super(in);
