...
/**
 * Represents the digest of the Notification message in according with the SyncML DM specification.
 * <p>
 ...
 *
 *
 * @version $Id: DigestNotificationMessage.java,v 1.3 2006/11/15 14:00:24 nichele Exp $
 */
public class DigestNotificationMessage {
     ...
     * Sets the nonce
     *
     * @param  nonce the nonce; if null, the property nonce is set to an empty array
     */
