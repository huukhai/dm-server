...
class WbxmlInitialiserFactory {
    ...
    /** OMA DM-DDF 1.2 **/
    static final Integer  DMDDF12_PUBLIC_ID_CODE = Integer.valueOf("02",16);
    ...
    private static final String DMDDF12_PUBLIC_ID         = "-//OMA//DTD-DM-DDF 1.2//EN";
    ...
    throws ClassNotFoundException
    {
        ...
        initClass=Class.forName("org.kxml.wap.DMDDFInitialiser");
        myPublicIdentifierMap.put(DMDDF12_PUBLIC_ID.toUpperCase(), initClass );
        myPublicIdentifierCodeMap.put(DMDDF12_PUBLIC_ID_CODE, initClass);
