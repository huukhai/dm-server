 ...
 * <ul>
 *   funambol.sessionid - the server session id
 * </ul>
 * <p>
 * <b>NOTE:</b> the prefix <i>funambol.</i> for property keys is reserved for
 * Funambol internal use.
 *
 * @version $Id: MessageProcessingContext.java,v 1.2 2006/08/07 21:09:20 nichele Exp $
 */
public class MessageProcessingContext implements Serializable {

    // --------------------------------------------------------------- Constants

    public static final String PROPERTY_SESSIONID = "funambol.sessionid";
    ...
    /**
     * Returns the value of the property associated to the given key
     *
