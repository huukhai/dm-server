...
/**
 * This class corresponds to the &lt;CTCap&gt; tag in the SyncML devinf DTD
 *
 * 
 *
 *  @version $Id: CTCap.java,v 1.2 2006/08/07 21:05:28 nichele Exp $
 */
public final class CTCap
implements java.io.Serializable {

    // ------------------------------------------------------------ Private data
    private ArrayList<CTTypeSupported> ctTypeSupported = new ArrayList<CTTypeSupported>();
     ...
     *
     */
    public CTCap(final CTTypeSupported[] ctTypeSupported) {
        setCTTypeSupported(ctTypeSupported);
    }
     ...
     */
    public void setCTTypeSupported(CTTypeSupported[] ctTypeSupported) {

        if (ctTypeSupported == null || ctTypeSupported.length == 0) {
            throw new IllegalArgumentException("ctTypeSupported cannot be null");
        }
        this.ctTypeSupported.clear();
        this.ctTypeSupported.addAll(Arrays.asList(ctTypeSupported));
    }
}
