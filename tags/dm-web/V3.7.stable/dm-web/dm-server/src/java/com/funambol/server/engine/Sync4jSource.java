 ...
 *
 * @version $Id: Sync4jSource.java,v 1.3 2006/11/15 15:26:36 nichele Exp $
 */
public class Sync4jSource {
    ...
    public Sync4jSource(String uri, String config, String sourceTypeId, String sourceName) {
        this.uri    = uri   ;
        this.config = config;
    ...
    /**
     * Returns a String representation of this Sync4jSource
     * 
     * @return String
     */
