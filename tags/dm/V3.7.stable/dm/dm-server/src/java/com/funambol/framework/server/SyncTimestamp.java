 ...
 *
 *
 * @version $Id: SyncTimestamp.java,v 1.2 2006/08/07 21:09:22 nichele Exp $
 */
public class SyncTimestamp {
    ...
    /**
     * Creates a new instance of LastTimestamp when the only starting timestamp
    ...
    public SyncTimestamp(final long start) {
        this(String.valueOf(start), String.valueOf(start), start, -1);
    }
