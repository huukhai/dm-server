...
public interface Errors {
    ...
    public static final String ERRMSG_NO_NODE_FOR_DEVINF           =
        "No node specified for device info"
    ;

    public static final String ERRMSG_NO_ITEM_IN_RESULTS           =
        "The Results command {1} contains no items"
    ;

    public static final String ERRMSG_MISSING_SOURCE_ITEM          =
        "Missing Source in item"
    ;

    public static final String ERRMSG_WRONG_NUMBER_OF_ALERTS       =
        "No more than one Alert command expected in body"
    ;

    public static final String ERRMSG_MISSING_REPLACE              =
        "Missing required SyncBody/Replace"
    ;
}
